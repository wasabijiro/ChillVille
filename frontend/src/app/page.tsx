          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <ArrowPathIcon
                  ...
                  className="mx-auto h-6 w-6 ml-4 cursor-pointer text-gray-400 hover:text-white transition-colors"
                />
                {isMLProofVerified && (
                  <CheckBadgeIcon
            ...
            <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              <div className="relative overflow-hidden rounded-lg bg-gray-800 px-4 pb-12 pt-5 shadow border border-gray-700 sm:px-6 sm:pt-6">
                ...
                <dd className="mt-1 ml-16 flex flex-col items-start pb-6 sm:pb-7">
                  <p className="text-2xl font-semibold text-gray-100">{discordScore}</p>
              ...
              {stats.map((item) => (
                <div
                  key={item.name}
                  className="relative overflow-hidden rounded-lg bg-gray-800 px-4 pb-12 pt-5 shadow border border-gray-700 sm:px-6 sm:pt-6"
                >
                  <dt>
                    <div className="absolute rounded-md bg-indigo-500 p-3">
                      <item.icon
            ...
            <div className="grid sm:grid-cols-3 mt-12 gap-4">
              <div className="w-full">
                ...
                <button
                  className="w-full bg-indigo-600 text-white py-2 mt-2 rounded-lg flex items-center justify-center hover:bg-indigo-700 transition-colors"
                ...
                {mlProof && (
                  <div className="mt-4 bg-gray-800 border border-gray-700 p-4 rounded-lg max-h-64 max-w-lg overflow-y-auto">
                    <pre className="text-sm text-gray-300 whitespace-pre-wrap">{mlProof}</pre>
                  </div>
                )}
              </div>
              <div>
                ...
                <button
                  className="w-full bg-indigo-600 py-2 mt-2 rounded-lg text-white hover:bg-indigo-700 transition-colors"
              ...
              <div>
                ...
                {isMLProofVerified && (
                  <div className="mt-4">
                    <button
                      className="w-full bg-green-600 py-2 rounded-lg text-white hover:bg-green-700 transition-colors"
